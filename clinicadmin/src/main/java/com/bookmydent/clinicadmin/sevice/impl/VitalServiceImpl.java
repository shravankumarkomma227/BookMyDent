...
import com.bookmydent.clinicadmin.entity.Vitals;
import com.bookmydent.clinicadmin.feignclient.DoctorServiceFeign;
import com.bookmydent.clinicadmin.repository.VitalsRepository;
import com.bookmydent.clinicadmin.service.VitalService;
...
public class VitalServiceImpl implements VitalService{
	...
	public Response postVitalsById(String patientId, VitalsDTO dto) {
		...
		try {
		ResponseEntity<?> bookingResponse=doctorServiceFeign.getAppointmentsByPatientId(token.access_token,patientId);

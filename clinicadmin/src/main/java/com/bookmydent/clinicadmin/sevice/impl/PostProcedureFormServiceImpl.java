...
import com.bookmydent.clinicadmin.repository.PostProcedureFormRepository;
import com.bookmydent.clinicadmin.service.PostProcedureFormService;
    ...
    public Response addPostProcedureForm(String hospitalId, String subServiceId, PostProcedureFormDTO dto) {
        ...
        try {
            ResponseEntity<ResponseStructure<SubServicesDto>> subServiceResponse =
                    serviceFeignClient.getSubServiceBySubServiceId(token.access_token, hospitalId, subServiceId);

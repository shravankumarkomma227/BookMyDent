...
import com.bookmydent.clinicadmin.dto.CustomerRatingDomain;
import com.bookmydent.clinicadmin.dto.RatingCategoryStats;
import com.bookmydent.clinicadmin.dto.RatingsDTO;
import com.bookmydent.clinicadmin.dto.Response;
import com.bookmydent.clinicadmin.feignclient.CustomerServiceFeignClient;
    ...
    public Response calculateAverageRating(String hospitalId, String doctorId) {
        ...
        try {
            ResponseEntity<Response> responseEntity =
                    customerServiceFeignClient.getRatingInfo(token.access_token,hospitalId, doctorId);

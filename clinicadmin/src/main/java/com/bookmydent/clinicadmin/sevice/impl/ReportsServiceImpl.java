...
import com.bookmydent.clinicadmin.dto.BookingResponse;
...
import com.bookmydent.clinicadmin.entity.Reports;
import com.bookmydent.clinicadmin.entity.ReportsList;
import com.bookmydent.clinicadmin.feignclient.BookingFeign;
import com.bookmydent.clinicadmin.repository.ReportsRepository;
import com.bookmydent.clinicadmin.service.ReportsService;
	...
	public Response saveReports(ReportsDtoList dto) {
		try {
			...
			for (ReportsDTO d : dto.getReportsList()) {
				...
				reports.add(report);}
				ResponseEntity<ResponseStructure<BookingResponse>> r = bookingFeign.getBookedService(token.access_token,bkngId);
				BookingResponse res = r.getBody().getData();
				if(res!=null) {			
					res.setReports(dto);
					bookingFeign.updateAppointment(token.access_token,res);}

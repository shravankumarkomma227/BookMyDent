...
import com.bookmydent.clinicadmin.dto.CategoryDto;
...
import com.bookmydent.clinicadmin.service.CategoryService;
...
public class CategoryServiceImpl implements CategoryService {
	...
	public Response getCategoryById(String categoryId) {
	    ...
	    try {
	        ResponseEntity<ResponseStructure<CategoryDto>> res = serviceFeignClient.getCategoryById(token.access_token,categoryId);
	...
	public Response getAllCategory() {
		Response response= new Response();
		try {
			ResponseEntity<ResponseStructure<List<CategoryDto>>> res=serviceFeignClient.getAllCategory(token.access_token);
			if(res.hasBody() && res.getBody()!=null) {

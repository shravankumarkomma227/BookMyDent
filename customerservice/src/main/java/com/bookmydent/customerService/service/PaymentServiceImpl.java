...
import com.bookmydent.customerService.dto.*;
import com.bookmydent.customerService.entity.GatewayResponse;
...
import com.bookmydent.customerService.repository.PaymentRepository;
...
public class PaymentServiceImpl implements PaymentService {
    ...
    public Response createPayment(PaymentDTO paymentDTO) {
        ...
        String clinicId;
        try {
            ResponseEntity<Response> doctorResponseEntity = clinicAdminFeignClient.getDoctorById(jwtToken,paymentDTO.getDoctorId());
        ...
        try {
            Response clinicResponse = adminFeign.getClinicById(jwtToken,clinicId);
        ...
        try {
            ResponseEntity<ResponseStructure<BookingResponse>> bookingResponseEntity =
                bookingFeignClient.getBookedService("hhhh",bookingId);

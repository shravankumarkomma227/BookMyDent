package com.dentalcare.category_services.controller;
...
import com.dentalcare.category_services.service.Impl.SubServiceInfoServiceImpl;
...
public class SubServicesInfoController {
	...
	public ResponseEntity<?> getSubServiceInfoByIdCategory(@PathVariable String categoryId) {
	...
	public ResponseEntity<?> getSubServicesInfoByServiceId(@PathVariable String serviceId) {
	...
	public ResponseEntity<?> getAllSubServicesInfo() {
	...
	public ResponseEntity<?> deleteSubServiceInfo(@PathVariable String subServiceId) {

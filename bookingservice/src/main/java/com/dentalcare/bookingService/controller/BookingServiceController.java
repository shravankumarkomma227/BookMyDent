package com.dentalcare.bookingService.controller;
...
public class BookingServiceController {
	...
	public ResponseEntity<ResponseStructure<BookingResponse>> deleteBookedService(@PathVariable String id) {
		...
		if(response != null) {
			return new ResponseEntity<>(ResponseStructure.buildResponse(response, "Appointment Deleted Sucessfully",
					HttpStatus.OK, HttpStatus.OK.value()), HttpStatus.OK);}
			else {
				return new ResponseEntity<>(ResponseStructure.buildResponse(null, "Appointment Not Found",
						HttpStatus.OK, HttpStatus.OK.value()), HttpStatus.OK);}}
	...
	public ResponseEntity<ResponseStructure<BookingResponse>> getBookedService(@PathVariable String id) {
		...
		if(response != null) {
		return new ResponseEntity<>(ResponseStructure.buildResponse(response, "Appointment Fetched Sucessfully",
				HttpStatus.OK, HttpStatus.OK.value()), HttpStatus.OK);}
		else {
			return new ResponseEntity<>(ResponseStructure.buildResponse(null, "Appointment Not Found",
					HttpStatus.OK, HttpStatus.OK.value()), HttpStatus.OK);}

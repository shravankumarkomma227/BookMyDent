package com.bookmydent.authservice.config;
...
import com.bookmydent.authservice.serviceImpl.CustomUserDetailsService;
import com.bookmydent.authservice.util.JWTAthenticationEntryPoint;

package com.dentalcare.authservice.config;
...
import com.dentalcare.authservice.serviceImpl.CustomUserDetailsService;
import com.dentalcare.authservice.util.JWTAthenticationEntryPoint;

...
import com.bookmydent.doctorservice.dermacaredoctorutils.VisitTypeUtil;
import com.bookmydent.doctorservice.dto.BookingResponse;
import com.bookmydent.doctorservice.dto.DatesDTO;
import com.bookmydent.doctorservice.dto.DoctorSaveDetailsDTO;
import com.bookmydent.doctorservice.dto.FollowUpDetailsDTO;
import com.bookmydent.doctorservice.dto.MedicinesDTO;
import com.bookmydent.doctorservice.dto.PrescriptionDetailsDTO;
import com.bookmydent.doctorservice.dto.Response;
import com.bookmydent.doctorservice.dto.SymptomDetailsDTO;
import com.bookmydent.doctorservice.dto.TestDetailsDTO;
import com.bookmydent.doctorservice.dto.TreatmentDetailsDTO;
import com.bookmydent.doctorservice.dto.TreatmentResponseDTO;
import com.bookmydent.doctorservice.feignclient.BookingFeignClient;
import com.bookmydent.doctorservice.feignclient.ClinicAdminServiceClient;
import com.bookmydent.doctorservice.model.Dates;
import com.bookmydent.doctorservice.model.DoctorSaveDetails;
import com.bookmydent.doctorservice.model.FollowUpDetails;
import com.bookmydent.doctorservice.model.Medicines;
import com.bookmydent.doctorservice.model.PrescriptionDetails;
import com.bookmydent.doctorservice.model.SymptomDetails;
import com.bookmydent.doctorservice.model.TestDetails;
import com.bookmydent.doctorservice.model.TreatmentDetails;
import com.bookmydent.doctorservice.model.TreatmentResponse;
import com.bookmydent.doctorservice.repository.DoctorSaveDetailsRepository;
import com.bookmydent.doctorservice.service.DoctorSaveDetailsService;
...
public class DoctorSaveDetailsServiceImpl implements DoctorSaveDetailsService {
    ...
    public Response saveDoctorDetails(DoctorSaveDetailsDTO dto) {
        try {
            ...
            Response doctorResponse = clinicAdminClient.getDoctorById(token.access_token,  dto.getDoctorId()).getBody();
            ...
            BookingResponse bookres = bookingFeignClient.getBookedService(token.access_token,saved.getBookingId()).getBody().getData();
            ...
            bookingFeignClient.updateAppointment(token.access_token,bookres);

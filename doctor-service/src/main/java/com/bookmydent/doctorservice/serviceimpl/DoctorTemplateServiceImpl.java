...
import com.bookmydent.doctorservice.dto.DoctorTemplateDTO;
...
import com.bookmydent.doctorservice.model.DoctorTemplate;
...
import com.bookmydent.doctorservice.repository.DoctorTemplateRepository;
import com.bookmydent.doctorservice.service.DoctorTemplateService;
...
//                    : null)
                ...
                .tests(entity.getTests() != null ?
                    com.bookmydent.doctorservice.dto.TestDetailsDTO.builder()
                ...
                .followUp(entity.getFollowUp() != null ?
                    com.bookmydent.doctorservice.dto.FollowUpDetailsDTO.builder()
                ...
                .prescription(entity.getPrescription() != null ?
                    com.bookmydent.doctorservice.dto.PrescriptionDetailsDTO.builder()
                        .medicines(entity.getPrescription().getMedicines().stream()
                            .map(med -> com.bookmydent.doctorservice.dto.MedicinesDTO.builder()

...
import com.dentalcare.doctorservice.dto.DoctorTemplateDTO;
...
import com.dentalcare.doctorservice.model.DoctorTemplate;
...
import com.dentalcare.doctorservice.repository.DoctorTemplateRepository;
import com.dentalcare.doctorservice.service.DoctorTemplateService;
...
//                    : null)
                ...
                .tests(entity.getTests() != null ?
                    com.dentalcare.doctorservice.dto.TestDetailsDTO.builder()
                ...
                .followUp(entity.getFollowUp() != null ?
                    com.dentalcare.doctorservice.dto.FollowUpDetailsDTO.builder()
                ...
                .prescription(entity.getPrescription() != null ?
                    com.dentalcare.doctorservice.dto.PrescriptionDetailsDTO.builder()
                        .medicines(entity.getPrescription().getMedicines().stream()
                            .map(med -> com.dentalcare.doctorservice.dto.MedicinesDTO.builder()
